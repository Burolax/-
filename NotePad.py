...
html_doc_text = '''<!--...--> Используется для добавления комментариев.
...
kb.add_abbreviation('[', '[]')
kb.add_abbreviation('{', '{}')
kb.add_abbreviation('a', '<a></a>')
kb.add_abbreviation('p', '<p></p>')
kb.add_abbreviation('h1', '<h1></h1>')
kb.add_abbreviation('h2', '<h2></h2>')
kb.add_abbreviation('h3', '<h3></h3>')
kb.add_abbreviation('div', '<div></div>')
kb.add_abbreviation('header', '<header></header>')
kb.add_abbreviation('footer', '<footer></footer>')
kb.add_abbreviation('id', 'id=""')
kb.add_abbreviation('cl', 'class=""')
kb.add_abbreviation('c', '<!-- ->')
kb.add_abbreviation('style', 'style')

#css
kb.add_abbreviation('bg', 'background-color:;')
kb.add_abbreviation('ff', 'font-family:;')
kb.add_abbreviation('fs', 'font-size:;')
...
internet_menu = Menu(main_menu)
doc_menu = Menu(main_menu)
...
internet_menu.add_command(label='Youtube', command=zy)
internet_menu.add_command(label='stackoverflow', command=zs)


doc_menu.add_command(label='HTML doc', command=html_doc)


main_menu.add_cascade(label='Func', menu=file_menu)
main_menu.add_cascade(label='Internet', menu=internet_menu)
main_menu.add_cascade(label='Doc', menu=doc_menu)

root.config(menu=main_menu)


f_text = c.CTkFrame(root)
f_text.pack(fill=BOTH, expand=1)


text_fild = c.CTkTextbox(f_text, padx=10, pady=10, wrap=WORD, text_color='White')
